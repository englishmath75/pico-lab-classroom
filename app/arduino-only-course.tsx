...
import { AlertTriangle, ArrowLeft, ArrowRight, Check, CheckCircle2, CircuitBoard, Clock3, ExternalLink, FlaskConical, FunctionSquare, Lightbulb, ShieldCheck, Wrench } from "lucide-react";
...
export function ArduinoOnlyCourse({ onBack, onGoPico }: { onBack: () => void; onGoPico: () => void }) {
  ...
  const choose = (lessonNumber:number, a=0) => {
    setLessonId(lessonNumber); setActivityId(a); setStage("circuit");
